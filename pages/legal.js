...
http://www.retireredi.com website and the App operated by Retire Redi LLC ("us", "we", or "our").
Your access to and use of the Service is conditioned on your acceptance of and compliance with
these Terms. These Terms apply to all visitors, users and others who access or use the Service.
By accessing or using the Service you agree to be bound by these Terms. If you disagree
with any part of the terms then you may not access the Service. The privacy policy ("policy") will help you understand how Retire Redi ("us", "we", "our") 
uses and protects the data you provide to us when you visit and use Retireredi.com ("website", "service").
...
by Retire Redi.
Retire Redi has no control over, and assumes no responsibility for, the content,
privacy policies, or practices of any third party web sites or services. You further acknowledge and
agree that Retire Redi shall not be responsible or liable, directly or indirectly, for any
